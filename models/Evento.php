...
class Evento extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id', 'dia_id', 'hora_id', 'expositor_id'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->expositor_id = $args['expositor_id'] ?? '';
    }
    ...
    public function validar() {
        ...
        if(!$this->expositor_id || !filter_var($this->expositor_id, FILTER_VALIDATE_INT) ) {
